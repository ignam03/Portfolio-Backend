...
import com.portfoliobackend.security.jwtUtil.JwtUtils;
import com.portfoliobackend.security.jwtUtil.request.LoginRequest;
import com.portfoliobackend.security.jwtUtil.request.SignupRequest;
import com.portfoliobackend.security.jwtUtil.response.JwtResponse;
import com.portfoliobackend.security.jwtUtil.response.MessageResponse;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "mod":
                        Rol modRole = roleRepository.findByName(ERol.ROLE_MODERATOR)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
